...
public class Client implements Cloneable {
    ...
    public String toString() {
        return "Client{" +
                "id=" + id +
                ", name='" + name + '\'' +
                ", address='" + nullableObjectToString(address) + '\'' +
                ", phones='" + nullableListToString(phones) + '\'' +
                '}';
    }

    private String nullableListToString(List<?> objects) {
        if (Objects.isNull(objects)) {
            return "null";
        }
        return objects.stream()
                .map(this::nullableObjectToString)
                .collect(Collectors.joining(" ,"));
    }

    private String nullableObjectToString(Object object) {
